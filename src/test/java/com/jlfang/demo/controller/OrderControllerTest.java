...
class OrderControllerTest {
    ...
    @Nested
    class CreateTakeAndGetOrderTests {
        /**
    ...
    void testGetOrderStatus(long orderId, String expectedStatus) {
        // Given
        given(orderService.getOrderStatus(orderId)).willReturn(expectedStatus);
    ...
    void testGetOrderNotFound() {
        // Given
        given(orderService.getOrder(anyLong())).willThrow(new OrderNotFoundException("Order not found"));
